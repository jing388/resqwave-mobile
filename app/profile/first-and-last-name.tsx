          ...
          >
            ...
            <View style={{ paddingTop: insets.top + 16 }} className="px-5">
              <View className="flex-row items-center justify-between mb-8">
                ...
                <Text className="text-white text-xl font-geist-semibold">Edit Name</Text>
                <View style={{ width: 40 }} />
              </View>
            </View>
            ...
            <View className="px-6 gap-6">
              ...
              <View>
                ...
                <View className={`bg-gray-800 rounded-xl border h-16 px-4 justify-center ${isFocused.firstName ? 'border-blue-500' : 'border-gray-600'}`}>
                  <TextInput
                    value={firstName}
              ...
              <View>
                ...
                <View className={`bg-gray-800 rounded-xl border h-16 px-4 justify-center ${isFocused.lastName ? 'border-blue-500' : 'border-gray-600'}`}>
                  <TextInput
                    value={lastName}
