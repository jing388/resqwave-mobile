...
export default function ChangePasswordScreen() {
  ...
  const handleChangePassword = () => {
    if (!isFormValid()) {
      Alert.alert('Error', 'Please ensure all fields are filled correctly and new passwords match.');
      return;
    }
          ...
          >
            ...
            <View style={{ paddingTop: insets.top + 16 }} className="px-5">
              <View className="flex-row items-center justify-between mb-8">
                ...
                <Text className="text-white text-xl font-geist-semibold">Change Password</Text>
                <View style={{ width: 40 }} />
              </View>
            </View>
              ...
              <View className="gap-6">
                ...
                <View>
                  ...
                  {confirmPassword.length > 0 && newPassword !== confirmPassword && (
                    <Text className="text-xs mt-2 font-geist-regular" style={{ color: '#EF4444' }}>
